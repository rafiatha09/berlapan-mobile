...
var travelData = [
  {
    ...
    "image": "assets/images/gambar_satu.png"
  },
  {
    ...
    "image": "assets/images/gambar_dua.png"
  },
  {
    ...
    "image": "assets/images/gambar_tiga.png"
  },
  {
...
class OrangKuat{
  ...
  OrangKuat(this.name, this.country, this.image, this.thoughts);
}

List<OrangKuat> Data = OrangData.map((item) => OrangKuat(item['name'].toString(),item['country'].toString(),item['image'].toString(), item['thought'].toString())).toList();

var OrangData = [
  {"name": "Lala", "country":"Jakarta", "image": "assets/images/orang_pertama.png",
    "thought": "Waktu itu aku sekarat karena kurangnya tersedia stock darah untuk didonor"
  },
  {"name": "Muthi", "country":"Bandung", "image": "assets/images/orang_kedua.png",
    "thought": "Aku sempat dirawat di ICU karen covid ini. Untungnya aku sembuh karena ada pendonor plasma darah yang baik hati",
  },
  {"name": "Agus", "country":"Banten", "image": "assets/images/orang_ketiga.png",
    "thought": "Kandungan ku tidak selamat kaarena rumah sakit kebahabisan stock tabung oksigen",
  },
  {"name": "Danang", "country":"Surabaya", "image": "assets/images/orang_keempat.png",
    "thought":"Kami berdua beruntung mendapatkan perawatan setelah aku membagikan musibahku di sosmed"
  }
];
...
List<CarouselModel> carousels= carouselsData.map((item) => CarouselModel(item['image'].toString())).toList();


var carouselsData = [
  {"image": "assets/images/carousel_discount_first.png"},
  {"image": "assets/images/carousel_discount_second.png"},
  {"image": "assets/images/carousel_discount_third.png"}
];